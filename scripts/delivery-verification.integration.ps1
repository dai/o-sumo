  ...
  try {
    while ($true) {
      ...
      if ($route -eq "/api/v1/torikumi.json") {
        ...
        $body = "<html><head><title>$title</title><link rel=`"canonical`" href=`"$canonical`"><meta name=`"description`" content=`"$description`"><meta property=`"og:title`" content=`"$title`"><meta property=`"og:description`" content=`"$description`"><meta property=`"og:url`" content=`"$canonical`"><meta property=`"og:image`" content=`"https://osada.us/og-default.jpg?v=20260913`"><meta property=`"og:type`" content=`"website`"><meta property=`"og:site_name`" content=`"o-sumo`"><meta property=`"og:image:width`" content=`"1280`"><meta property=`"og:image:height`" content=`"640`"><meta name=`"twitter:card`" content=`"summary_large_image`"><meta name=`"twitter:title`" content=`"$title`"><meta name=`"twitter:description`" content=`"$description`"><meta name=`"twitter:image`" content=`"https://osada.us/og-default.jpg?v=20260913`"></head><body>fixture</body></html>"
