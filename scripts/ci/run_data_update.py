...
# The torikumi generator refreshes these rank-derived artifacts together with
# the selected torikumi scope. Keep them in the explicit allowlist so a valid
# result update is not rejected after generation.
TORIKUMI = (
