...
- GitHub Actions は日次更新（JST 14:00）と結果更新（JST 14:00, 14:30, 15:00, 15:30, 16:00, 16:30, 17:00, 17:30, 18:00, 19:00, 20:00）を自動実行します。
- 明日以降に手動実行する場合は GitHub Actions の `Run workflow` から `Daily Sumo Data Update` または `Realtime Torikumi Update` を `main` に対して起動します。
...
- 結果更新 workflow では JST 20:30 の監視ジョブで `resultUpdatedAt` 当日化を確認し、未反映なら warning を出します。
...
- [2026年五月場所所属力士辞書 `rikishi-202605.txt`](./rikishi-202605.txt)
