...
- ポリシー: [`docs/api/policy.md`](./docs/api/policy.md)
- 変更履歴: [`docs/api/changelog.md`](./docs/api/changelog.md)
...
- 障害・更新遅延・廃止予定は GitHub Issues で告知します:
  - https://github.com/dai/o-sumo/issues
- API レスポンス変更は `docs/api/changelog.md` に記録します。
